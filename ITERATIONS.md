...
| 11 | Eagles Eyrie | RealPage/OneSite 'Rent Roll 4.2' (flat export; 2-property book, **Eagles sheet only** per analyst) | 09/10/26 | 80 units, 74 occ / 6 vac, 92.5%; ties **exactly** to the source "Eagles Eyrie Total:" row + Status Summary (Units 80 · Occ 74 · Vac 6 · SF 112,400 · Market 114,490 · Scheduled 100,522). Unit rows keyed off the `EAGL` look-up code (col A) to skip the trailing Status/Charge-Code summaries. Unit type "NxM …" → BD/BA; plans 2x2 / 2x2 Townhouse / 3x3 Townhouse kept distinct. Per-charge detail hidden → "Scheduled Charges" used as in-place (bundles base Rent 97,172 + Amenity Rent 3,350; not splittable per unit). Real Market Rent (RI) column → `market_from_inplace` off. |
| 10 | Saddlebrook at Tates Creek | Yardi 'Rent Roll with Lease Charges' (charge ledger) | 07/05/26 | 181 units, 171 occ / 9 vac / 1 non-rev, 94.48%; ties **exactly** to source Summary Groups + charge summary (Units 181 · SF 185,350 [occ 174,790 / vac 9,573 / non-rev 987] · Market 244,146 · conrent 229,667 · Other 10,324 · Emp disc −3,092 · Lease charges 236,899). Charge codes: base=`conrent`; other income=`conpest/contfinc/coninsu/congarg/conpetrt/conliab`; `conempl`→employee discount (kept separate). Beds inferred from type prefix (`a`→1BR, `b`→2BR); `stc_eh`=Executive Home; unit 092 "MODEL" auto-detected non-rev. |
| 9 | Pendale Towers | AppFolio 'Rent Roll' (single property, Pittsburgh PA) | 07/30/26 | 132 units, ties **exactly** to source grand total (Units 132 · SF 114,814 · Market 165,945 · Rent 159,144.16). Exhibits show **residential only** (130 units, 124 occ / 6 vac, 95.38%) after excluding 2 non-residential `--/--` rows (Rooftop Antenna cell-site license + 106/107 Commercial Suite). `Vacant-Rented` treated as vacant (matches source 95.5% occ); owner-operated "Birgo AirBnB" guest suite ($0) kept occupied, marked to its $1,025 market by the $0-placeholder rule. Source carries a real Market Rent column, so `market_from_inplace` off. |
